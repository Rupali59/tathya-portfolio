      ...
      <section className="py-16 bg-background-secondary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Website Analysis */}
            <div className="bg-card-bg rounded-lg p-6 border border-card-border hover:border-accent/50 transition-colors">
              ...
              <p className="text-text-secondary mb-4">
                Comprehensive analysis of your website&apos;s performance, SEO,
                and user experience.
              </p>
              ...
              <button className="w-full bg-primary hover:bg-primary-700 text-background py-2 rounded-lg font-semibold transition-colors text-sm">
                Get Quote
              </button>
            </div>

            {/* Custom Website Development */}
            <div className="bg-card-bg rounded-lg p-6 border-2 border-accent relative">
              ...
              <button className="w-full bg-accent hover:bg-accent-600 text-primary py-2 rounded-lg font-semibold transition-colors text-sm">
                Get Quote
              </button>
            </div>
      ...
      <section className="py-16 bg-background-primary">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Custom Integrations */}
            <div className="bg-primary rounded-lg p-8 border border-card-border">
              ...
              <ul className="text-text-tertiary space-y-2 mb-6">
              ...
              <button className="w-full bg-secondary hover:bg-secondary-600 text-background py-3 rounded-lg font-semibold transition-colors">
                Discuss Project
              </button>
            </div>
            ...
            <div className="bg-primary rounded-lg p-8 border border-card-border">
              ...
              <div className="text-3xl font-bold text-text-tertiary mb-4">
                TBA
              </div>
              <ul className="text-text-tertiary space-y-2 mb-6">
              ...
              <button className="w-full bg-primary-700 text-primary-400 py-3 rounded-lg font-semibold cursor-not-allowed">
                Coming Soon
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-card-bg rounded-lg p-6 border border-card-border">
              ...
              <div className="text-accent font-semibold">₹2,000/page</div>
            </div>
            ...
            <div className="bg-card-bg rounded-lg p-6 border border-card-border">
              ...
              <div className="text-accent font-semibold">₹8,000 - ₹25,000</div>
            </div>
            ...
            <div className="bg-card-bg rounded-lg p-6 border border-card-border">
              ...
              <div className="text-accent font-semibold">₹5,000 - ₹15,000</div>
            </div>
            ...
            <div className="bg-card-bg rounded-lg p-6 border border-card-border">
              ...
              <div className="text-accent font-semibold">₹3,000/hour</div>
            </div>
            ...
            <div className="bg-card-bg rounded-lg p-6 border border-card-border">
              ...
              <div className="text-accent font-semibold">₹5,000/month</div>
            </div>
            ...
            <div className="bg-card-bg rounded-lg p-6 border border-card-border">
              ...
              <div className="text-accent font-semibold">₹10,000 - ₹30,000</div>
            </div>
            ...
            <div className="bg-card-bg rounded-lg p-6 border border-card-border">
              ...
              <div className="text-accent font-semibold">₹15,000 - ₹50,000</div>
            </div>
            ...
            <div className="bg-card-bg rounded-lg p-6 border border-card-border">
              ...
              <div className="text-accent font-semibold">₹20,000 - ₹75,000</div>
            </div>
          </div>
        </div>
      </section>
