...
import { getCachedAnalyticsData } from "@/lib/cache";

// Admin dashboard page
export default async function AdminDashboard() {
  const analyticsData = await getCachedAnalyticsData();
