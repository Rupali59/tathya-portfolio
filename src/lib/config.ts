...
export const appConfig = {
  url: process.env.NEXT_PUBLIC_APP_URL || process.env.NEXT_PUBLIC_SITE_URL || `http://localhost:${port}`,
  name: process.env.NEXT_PUBLIC_APP_NAME || process.env.NEXT_PUBLIC_SITE_NAME || 'Tathya',
  description: process.env.NEXT_PUBLIC_APP_DESCRIPTION || process.env.NEXT_PUBLIC_SITE_DESCRIPTION || 'Engineered Business Ecosystems',
} as const;
...
export const siteConfig = {
  ...
  description: process.env.NEXT_PUBLIC_SITE_DESCRIPTION || 'End-to-End Business Websites & CRM Solutions',
...
export const analyticsConfig = {
  enabled: getBoolean('NEXT_PUBLIC_ANALYTICS_ENABLED', process.env.NODE_ENV === 'production'),
...
export const socialConfig = {
  ...
  linkedin: getString('NEXT_PUBLIC_LINKEDIN_URL', 'https://linkedin.com/in/rupali-bhatnagar-b4864957'),
  twitter: getString('NEXT_PUBLIC_TWITTER_URL', 'https://twitter.com/rupali_dev'),
} as const;
