  ...
  async (serviceSlug: string) => {
    ...
    const services = {
      ...
      'crm-integration': {
        ...
        description: 'Seamless customer relationship management systems that streamline your sales and support processes.',
        features: [
        ...
        technologies: ['Salesforce', 'HubSpot', 'Zapier', 'Node.js', 'PostgreSQL'],
  ...
  async () => {
    ...
    return [
      ...
      },
      {
        ...
        description: 'Comprehensive CRM solution with automated workflows and analytics dashboard.',
    ...
    return [
      {
        ...
        answer: 'We offer flexible pricing models including fixed-price projects, hourly rates, and retainer agreements. Our pricing starts from $2,500 for basic websites and scales based on project complexity.',
        category: 'Pricing'
      },
      {
        id: 'timeline',
        question: 'How long does a typical project take?',
        answer: 'Project timelines vary based on scope and complexity. Simple websites take 2-4 weeks, while complex web applications can take 8-16 weeks. We provide detailed timelines during the discovery phase.',
        category: 'Process'
      },
      {
        id: 'support',
        question: 'Do you provide ongoing support?',
        answer: 'Yes, we offer comprehensive support packages including maintenance, updates, security patches, and performance monitoring. Support packages start from $500/month.',
        category: 'Support'
      },
      {
        id: 'technologies',
        question: 'What technologies do you use?',
        answer: 'We use modern, proven technologies including React, Next.js, TypeScript, Node.js, PostgreSQL, and cloud platforms like AWS and Vercel. We choose the best technology stack for each project.',
        category: 'Technology'
      }
    ];
  },
