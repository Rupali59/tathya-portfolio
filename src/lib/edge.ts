...
export function trackEdgeEvent(
  event: string,
...
export function getPersonalizedContent(location: {
  country: string;
  region: string;
  city: string;
}) {
  ...
  const content = {
    hero: {
      ...
      subtitle:
        "We help businesses grow with custom web development and CRM solutions",
    },
    cta: {
